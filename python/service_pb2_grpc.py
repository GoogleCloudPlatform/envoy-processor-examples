...
class ExternalProcessor(object):
    ...
    def ProcessSimple(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/envoy.service.ext_proc.v3.ExternalProcessor/ProcessSimple',
            service__pb2.ProcessingRequest.SerializeToString,
            service__pb2.ProcessingResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def ProcessSimple1(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/envoy.service.ext_proc.v3.ExternalProcessor/ProcessSimple1',
            service__pb2.ProcessingRequest.SerializeToString,
            service__pb2.ProcessingResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ProcessSimple2(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/envoy.service.ext_proc.v3.ExternalProcessor/ProcessSimple2',
            service__pb2.ProcessingRequest.SerializeToString,
            service__pb2.ProcessingResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
